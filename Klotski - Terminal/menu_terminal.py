...
def start_terminal():
    print(" ")
    print("Hello! Welcome to Klotski in terminal!")
    print(" Whenever you want to quit the game, just type 'quit'.")
    print(" If you want to go back to the menu, type 'menu'.")
    print(" If you simply want to restart the level type 'r'.")
    print(" If don't know what to do next and need help, type 'hint'.")
